...
public abstract class MCH_HudItem extends Gui {
   ...
   public void drawTexture(
      ...
      tessellator.addVertexWithUV(-width / 2.0, height / 2.0, this.zLevel, uLeft * fx, (vTop + vHeight) * fy);
      tessellator.addVertexWithUV(width / 2.0, height / 2.0, this.zLevel, (uLeft + uWidth) * fx, (vTop + vHeight) * fy);
      tessellator.addVertexWithUV(width / 2.0, -height / 2.0, this.zLevel, (uLeft + uWidth) * fx, vTop * fy);
      tessellator.addVertexWithUV(-width / 2.0, -height / 2.0, this.zLevel, uLeft * fx, vTop * fy);
      tessellator.draw();
      GL11.glPopMatrix();
   }
