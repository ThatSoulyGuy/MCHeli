...
public class MCH_ItemUavStation extends W_Item {
   ...
   public ItemStack onItemRightClick(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer) {
      ...
      if (W_MovingObjectPosition.isHitTypeTile(movingobjectposition)) {
         ...
         MCH_EntityUavStation entityUavSt = this.createUavStation(par2World, var33 + 0.5F, j + 1.0F, k + 0.5F, this.UavStationKind);
         int rot = (int)(MCH_Lib.getRotate360(par3EntityPlayer.rotationYaw) + 45.0);
         entityUavSt.rotationYaw = rot / 90 * 90 - 180;
         entityUavSt.initUavPostion();
         if (!par2World.getCollidingBoundingBoxes(entityUavSt, entityUavSt.boundingBox.expand(-0.1, -0.1, -0.1)).isEmpty()) {
            return par1ItemStack;
         }
