...
public abstract class MCH_Gui extends GuiScreen {
   ...
   public void drawScreen(int par1, int par2, float partialTicks) {
      ...
      if (!this.mc.gameSettings.hideGUI) {
         ...
         if (this.mc.thePlayer != null) {
            this.drawGui(this.mc.thePlayer, this.mc.gameSettings.thirdPersonView != 0);
         }
   ...
   public void drawTexturedModalRectRotate(
      ...
      tessellator.addVertexWithUV(-width / 2.0, height / 2.0, this.zLevel, uLeft * 0.00390625, (vTop + vHeight) * 0.00390625);
      tessellator.addVertexWithUV(width / 2.0, height / 2.0, this.zLevel, (uLeft + uWidth) * 0.00390625, (vTop + vHeight) * 0.00390625);
      tessellator.addVertexWithUV(width / 2.0, -height / 2.0, this.zLevel, (uLeft + uWidth) * 0.00390625, vTop * 0.00390625);
      tessellator.addVertexWithUV(-width / 2.0, -height / 2.0, this.zLevel, uLeft * 0.00390625, vTop * 0.00390625);
      tessellator.draw();
      GL11.glPopMatrix();
   }
   ...
   public void drawPoints(ArrayList<Double> points, int color, int pointWidth) {
      ...
      for (int i = 0; i < points.size(); i += 2) {
         tessellator.addVertex(points.get(i), points.get(i + 1), 0.0);
      }
