...
public class MCH_GuiTitle extends MCH_Gui {
   ...
   public void setupTitle(IChatComponent chatComponent, int showTime, int pos) {
      ...
      int k = MathHelper.floor_float(this.func_146233_a() / this.mc.gameSettings.chatScale);
      int l = 0;
      ...
      for (int i1 = 0; i1 < arraylist1.size(); i1++) {
         ...
         for (String sLine : splitLine) {
            String s = this.func_146235_b(ichatcomponent1.getChatStyle().getFormattingCode() + sLine);
      ...
      for (IChatComponent ichatcomponent2 : (java.util.List<IChatComponent>)arraylist) {
