...
public abstract class MCH_WeaponBase {
   ...
   public boolean use(MCH_WeaponParam prm) {
      ...
      prm.posX = prm.posX + v.xCoord;
      prm.posY = prm.posY + v.yCoord;
      prm.posZ = prm.posZ + v.zCoord;
      if (this.shot(prm)) {
         this.tick = 0;
         return true;
      } else {
   ...
   public double getLandInDistance(MCH_WeaponParam prm) {
      ...
      double spz = prm.posZ;
      Vec3 vs = Vec3.createVectorHelper(0.0, 0.0, 0.0);
      Vec3 ve = Vec3.createVectorHelper(0.0, 0.0, 0.0);
