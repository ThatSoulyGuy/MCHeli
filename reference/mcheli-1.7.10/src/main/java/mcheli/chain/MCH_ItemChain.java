...
public class MCH_ItemChain extends W_Item {
      ...
      if (!world.isRemote && entity != null && !entity.isDead) {
         ...
         if (entityTowed == null) {
            ...
            MCH_EntityChain chain = new MCH_EntityChain(
               world,
               (entityTowed.posX + entity.posX) / 2.0,
               (entityTowed.posY + entity.posY) / 2.0,
   ...
   public static MCH_EntityChain getTowedEntityChain(Entity entity) {
      List list = entity.worldObj.getEntitiesWithinAABB(MCH_EntityChain.class, entity.boundingBox.expand(25.0, 25.0, 25.0));
      if (list == null) {
         return null;
      }
