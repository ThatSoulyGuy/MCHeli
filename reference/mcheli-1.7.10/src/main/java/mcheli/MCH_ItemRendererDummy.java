...
public class MCH_ItemRendererDummy extends ItemRenderer {
   ...
   public void renderItemInFirstPerson(float par1) {
      ...
      } else if (!(mc.thePlayer.ridingEntity instanceof MCH_EntityAircraft)
         && !(mc.thePlayer.ridingEntity instanceof MCH_EntityUavStation)
         && !(mc.thePlayer.ridingEntity instanceof MCH_EntityGLTD)) {
         super.renderItemInFirstPerson(par1);
      }
   }
