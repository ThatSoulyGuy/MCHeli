...
implements IGuiHandler {
    ...
    public Object getServerGuiElement(int id, EntityPlayer player, World world, int x, int y, int z) {
        MCH_Lib.DbgLog((World)world, (String)"MCH_GuiCommonHandler.getServerGuiElement ID=%d (%d, %d, %d)", (Object[])new Object[]{id, x, y, z});
        switch (id) {
            case 0: {
                if (!(player.field_70154_o instanceof MCH_EntityUavStation)) break;
    ...
    public Object getClientGuiElement(int id, EntityPlayer player, World world, int x, int y, int z) {
        MCH_Lib.DbgLog((World)world, (String)"MCH_GuiCommonHandler.getClientGuiElement ID=%d (%d, %d, %d)", (Object[])new Object[]{id, x, y, z});
        switch (id) {
            case 0: {
                if (!(player.field_70154_o instanceof MCH_EntityUavStation)) break;
