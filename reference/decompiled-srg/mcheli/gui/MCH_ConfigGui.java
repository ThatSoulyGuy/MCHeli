...
extends W_GuiContainer {
    ...
    public MCH_ConfigGui(EntityPlayer player) {
        super((Container)new MCH_ConfigGuiContainer(player));
    ...
    public void func_73866_w_() {
        ...
        int id = 200;
        int idr = 300;
        MCH_GuiListItemKeyBind[] mCH_GuiListItemKeyBindArray = new MCH_GuiListItemKeyBind[23];
        mCH_GuiListItemKeyBindArray[0] = new MCH_GuiListItemKeyBind(200, 300, x1, "Up", MCH_Config.KeyUp);
        mCH_GuiListItemKeyBindArray[1] = new MCH_GuiListItemKeyBind(201, 301, x1, "Down", MCH_Config.KeyDown);
        mCH_GuiListItemKeyBindArray[2] = new MCH_GuiListItemKeyBind(202, 302, x1, "Right", MCH_Config.KeyRight);
        mCH_GuiListItemKeyBindArray[3] = new MCH_GuiListItemKeyBind(203, 303, x1, "Left", MCH_Config.KeyLeft);
        mCH_GuiListItemKeyBindArray[4] = new MCH_GuiListItemKeyBind(204, 304, x1, "Switch Gunner", MCH_Config.KeySwitchMode);
        mCH_GuiListItemKeyBindArray[5] = new MCH_GuiListItemKeyBind(205, 305, x1, "Switch Hovering", MCH_Config.KeySwitchHovering);
        mCH_GuiListItemKeyBindArray[6] = new MCH_GuiListItemKeyBind(206, 306, x1, "Switch Weapon1", MCH_Config.KeySwitchWeapon1);
        mCH_GuiListItemKeyBindArray[7] = new MCH_GuiListItemKeyBind(207, 307, x1, "Switch Weapon2", MCH_Config.KeySwitchWeapon2);
        mCH_GuiListItemKeyBindArray[8] = new MCH_GuiListItemKeyBind(208, 308, x1, "Switch Weapon Mode", MCH_Config.KeySwWeaponMode);
        mCH_GuiListItemKeyBindArray[9] = new MCH_GuiListItemKeyBind(209, 309, x1, "Zoom / Fold Wing", MCH_Config.KeyZoom);
        mCH_GuiListItemKeyBindArray[10] = new MCH_GuiListItemKeyBind(210, 310, x1, "Camera Mode", MCH_Config.KeyCameraMode);
        mCH_GuiListItemKeyBindArray[11] = new MCH_GuiListItemKeyBind(211, 311, x1, "Unmount Mobs", MCH_Config.KeyUnmount);
        mCH_GuiListItemKeyBindArray[12] = new MCH_GuiListItemKeyBind(212, 312, x1, "Flare", MCH_Config.KeyFlare);
        mCH_GuiListItemKeyBindArray[13] = new MCH_GuiListItemKeyBind(213, 313, x1, "Vtol / Drop / Fold Blade", MCH_Config.KeyExtra);
        mCH_GuiListItemKeyBindArray[14] = new MCH_GuiListItemKeyBind(214, 314, x1, "Third Person Distance Up", MCH_Config.KeyCameraDistUp);
        mCH_GuiListItemKeyBindArray[15] = new MCH_GuiListItemKeyBind(215, 315, x1, "Third Person Distance Down", MCH_Config.KeyCameraDistDown);
        mCH_GuiListItemKeyBindArray[16] = new MCH_GuiListItemKeyBind(216, 316, x1, "Switch Free Look", MCH_Config.KeyFreeLook);
        mCH_GuiListItemKeyBindArray[17] = new MCH_GuiListItemKeyBind(217, 317, x1, "Open GUI", MCH_Config.KeyGUI);
        mCH_GuiListItemKeyBindArray[18] = new MCH_GuiListItemKeyBind(218, 318, x1, "Gear Up Down", MCH_Config.KeyGearUpDown);
        mCH_GuiListItemKeyBindArray[19] = new MCH_GuiListItemKeyBind(219, 319, x1, "Put entity in the rack", MCH_Config.KeyPutToRack);
        mCH_GuiListItemKeyBindArray[20] = new MCH_GuiListItemKeyBind(220, 320, x1, "Drop entity from the rack", MCH_Config.KeyDownFromRack);
        mCH_GuiListItemKeyBindArray[21] = new MCH_GuiListItemKeyBind(221, 321, x1, "[MP]Score board", MCH_Config.KeyScoreboard);
        mCH_GuiListItemKeyBindArray[22] = new MCH_GuiListItemKeyBind(222, 322, x1, "[MP][OP]Multiplay manager", MCH_Config.KeyMultiplayManager);
        for (MCH_GuiListItemKeyBind item : listKeyBindItems = mCH_GuiListItemKeyBindArray) {
            this.keyBindingList.addItem((MCH_GuiListItem)item);
        }
    ...
    public void getAllStatusFromConfig() {
        ...
        this.sliderHitMark[1].setSliderValue((float)(MCH_Config.hitMarkColorRGB >> 16 & 0xFF));
        this.sliderHitMark[2].setSliderValue((float)(MCH_Config.hitMarkColorRGB >> 8 & 0xFF));
        this.sliderHitMark[3].setSliderValue((float)(MCH_Config.hitMarkColorRGB >> 0 & 0xFF));
    ...
    public void saveAndApplyConfig() {
        block4: {
            block3: {
                ...
                if (b1 != MCH_Config.AutoThrottleDownHeli.prmBool) break block3;
                if (b2 == MCH_Config.AutoThrottleDownPlane.prmBool) break block4;
            }
            ...
            switch (button.field_146127_k) {
                ...
                case 400: {
                    ...
                    if (ac != null && ac.getAcInfo() != null) {
                        ...
                        MCH_Lib.DbgLog((boolean)true, (String)("MCH_BaseInfo.reload : " + name), (Object[])new Object[0]);
                ...
                case 401: {
                    MCH_Lib.DbgLog((boolean)true, (String)"MCH_BaseInfo.reload all weapon info.", (Object[])new Object[0]);
    ...
    protected void func_146979_b(int par1, int par2) {
        ...
        if (this.currentScreenId == 0) {
            ...
            MCH_GuiTargetMarker.drawRhombus((Tessellator)Tessellator.field_78398_a, (int)15, (double)x, (double)y, (double)this.field_73735_i, (double)size, (int)color);
    ...
    protected void func_146976_a(float var1, int var2, int var3) {
        ...
        W_McClient.MOD_bindTexture((String)"textures/gui/config.png");
        GL11.glColor4f((float)1.0f, (float)1.0f, (float)1.0f, (float)1.0f);
        int x = (this.field_146294_l - this.field_146999_f) / 2;
        int y = (this.field_146295_m - this.field_147000_g) / 2;
        this.drawTexturedModalRectRotate((double)x, (double)y, (double)this.field_146999_f, (double)this.field_147000_g, 0.0, 0.0, (double)this.field_146999_f, (double)this.field_147000_g, 0.0f, 512.0, 256.0);
    }
    ...
    public void drawTexturedModalRectRotate(double left, double top, double width, double height, double uLeft, double vTop, double uWidth, double vHeight, float rot, double texWidth, double texHeight) {
        ...
        tessellator.func_78374_a(-width / 2.0, height / 2.0, (double)this.field_73735_i, uLeft * (double)fw, (vTop + vHeight) * (double)fh);
        tessellator.func_78374_a(width / 2.0, height / 2.0, (double)this.field_73735_i, (uLeft + uWidth) * (double)fw, (vTop + vHeight) * (double)fh);
        tessellator.func_78374_a(width / 2.0, -height / 2.0, (double)this.field_73735_i, (uLeft + uWidth) * (double)fw, vTop * (double)fh);
        tessellator.func_78374_a(-width / 2.0, -height / 2.0, (double)this.field_73735_i, uLeft * (double)fw, vTop * (double)fh);
        tessellator.func_78381_a();
        GL11.glPopMatrix();
    }
}
