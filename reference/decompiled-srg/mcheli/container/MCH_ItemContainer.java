...
extends W_Item {
    ...
    public ItemStack func_77659_a(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer) {
        ...
        if (W_MovingObjectPosition.isHitTypeTile((MovingObjectPosition)movingobjectposition)) {
            ...
            MCH_EntityContainer entityboat = new MCH_EntityContainer(par2World, (double)((float)i + 0.5f), (double)((float)j + 1.0f), (double)((float)k + 0.5f));
            entityboat.field_70177_z = ((MathHelper.func_76128_c((double)((double)(par3EntityPlayer.field_70177_z * 4.0f / 360.0f) + 0.5)) & 3) - 1) * 90;
            if (!par2World.func_72945_a((Entity)entityboat, entityboat.field_70121_D.func_72314_b(-0.1, -0.1, -0.1)).isEmpty()) {
                return par1ItemStack;
            }
