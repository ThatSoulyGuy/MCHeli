...
extends W_GuiContainer {
    ...
    public MCH_AircraftGui(EntityPlayer player, MCH_EntityAircraft ac) {
        super((Container)new MCH_AircraftGuiContainer(player, ac));
        this.aircraft = ac;
    ...
    public void func_73866_w_() {
        ...
        this.editCommand = new GuiTextField(this.field_146289_q, this.field_147003_i + 25, this.field_147009_r + 215, 160, 15);
    ...
    public void closeScreen() {
        MCH_PacketCommandSave.send((String)this.editCommand.func_146179_b());
    ...
    protected void func_146284_a(GuiButton button) {
        ...
        switch (button.field_146127_k) {
            ...
            case 1: {
                ...
                MCH_PacketIndReload.send((MCH_EntityAircraft)this.aircraft, (int)this.currentWeaponId);
            ...
            case 5: {
                MCH_PacketIndOpenScreen.send((int)2);
                break;
            }
            case 6: {
    ...
    protected void func_146979_b(int par1, int par2) {
        ...
        this.drawString(ac.getGuiInventory().func_145825_b(), 10, 10, 0xFFFFFF);
        ...
        if (this.aircraft.getWeaponNum() > 0) {
            ...
            if (ws != null && !(ws.getFirstWeapon() instanceof MCH_WeaponDummy)) {
                ...
                int color = rest == 0 ? 0xFF0000 : (rest == ws.getAllAmmoNum() ? 2675784 : 0xFFFFFF);
    ...
    protected void func_73869_a(char c, int code) {
        if (code == 1) {
            ...
            if (!s.isEmpty()) {
                MCH_PacketIndMultiplayCommand.send((int)768, (String)s);
            }
        } else {
    ...
    protected void func_146976_a(float var1, int var2, int var3) {
        ...
        W_McClient.MOD_bindTexture((String)"textures/gui/gui.png");
