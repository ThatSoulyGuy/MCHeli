...
public abstract class AbstractExpression {
    ...
    protected void let(long val, int pos) {
        this.let((Object)new Long(val), pos);
    }

    protected void let(double val, int pos) {
        this.let((Object)new Double(val), pos);
    }
    ...
    public boolean same(AbstractExpression exp) {
        return AbstractExpression.same((String)this.getOperator(), (String)exp.getOperator()) && AbstractExpression.same((String)this.getEndOperator(), (String)exp.getEndOperator()) && this.equals((Object)exp);
    }
