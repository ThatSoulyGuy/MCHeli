...
extends MCH_GuiScoreboard_Base {
    ...
    public void func_73866_w_() {
        ...
        this.editCreateTeamName = new GuiTextField(this.field_146289_q, x - 80, y - 55, 160, 20);
            ...
            switch (btn.field_146127_k) {
                case 528: {
                    ...
                    if (teamName.length() > 0 && teamName.length() <= 16) {
                        MCH_PacketIndMultiplayCommand.send((int)768, (String)("scoreboard teams add " + teamName));
                        MCH_PacketIndMultiplayCommand.send((int)768, (String)("scoreboard teams option " + teamName + " color " + colorNames[this.lastTeamColor]));
                        MCH_PacketIndMultiplayCommand.send((int)768, (String)("scoreboard teams option " + teamName + " friendlyfire " + friendlyFire));
                    }
                    this.switchScreen(MCH_GuiScoreboard_Base.SCREEN_ID.MAIN);
                    break;
                }
    ...
    protected void func_146976_a(float par1, int par2, int par3) {
        MCH_GuiScoreboard_CreateTeam.drawList((Minecraft)this.field_146297_k, (FontRenderer)this.field_146289_q, (boolean)true);
        W_ScaledResolution sr = new W_ScaledResolution(this.field_146297_k, this.field_146297_k.field_71443_c, this.field_146297_k.field_71440_d);
        int factor = sr.func_78325_e() > 0 ? sr.func_78325_e() : 1;
        W_McClient.MOD_bindTexture((String)"textures/gui/mp_new_team.png");
        ...
        EnumChatFormatting ecf = EnumChatFormatting.func_96300_b((String)colorNames[this.lastTeamColor]);
