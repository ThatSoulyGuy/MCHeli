...
extends MCH_GuiScoreboard_Base {
    ...
    public void func_73866_w_() {
        ...
        int WIDTH = MCH_GuiScoreboard_Main.getScoreboradWidth((Minecraft)this.field_146297_k) * 3 / 4;
        if (WIDTH < 80) {
            WIDTH = 80;
        }
        int LEFT = MCH_GuiScoreboard_Main.getScoreBoardLeft((Minecraft)this.field_146297_k, (int)(this.getTeamNum() + 1), (int)0) / 4;
    ...
    protected void func_146284_a(GuiButton btn) {
        if (btn != null && btn.field_146124_l) {
            switch (btn.field_146127_k) {
                case 256: {
                    MCH_PacketIndMultiplayCommand.send((int)256, (String)"");
                    break;
                }
                case 768: {
                    MCH_PacketIndMultiplayCommand.send((int)512, (String)"");
                    break;
                }
                case 512: {
                ...
                case 1024: {
                    MCH_PacketIndMultiplayCommand.send((int)1024, (String)"");
                    break;
                }
                case 1280: {
                    MCH_PacketIndMultiplayCommand.send((int)1280, (String)"");
                }
            }
        }
    }
    ...
    protected void func_146976_a(float par1, int par2, int par3) {
        MCH_GuiScoreboard_Main.drawList((Minecraft)this.field_146297_k, (FontRenderer)this.field_146289_q, (boolean)true);
    }
}
