...
public class MCH_Blade {
   ...
   public void setRotation(float rotation) {
      this.rotation = (float)MchMath.getRotate360(rotation);
   }
   ...
   public void setPrevRotation(float rotation) {
      this.prevRotation = (float)MchMath.getRotate360(rotation);
   }
   ...
   public boolean unfolding(float rot) {
      ...
      float targetRot = (float)MchMath.getRotate360(rot + this.baseRotation);
      float prevRot = this.rotation;
      if (targetRot <= 180.0F) {
         this.rotation = (float)MchMath.getRotate360(this.rotation + this.foldSpeed);
