...
public class MCH_WeaponGuidanceSystem {
         ...
         for (int i = 0; i < list.size(); i++) {
            ...
            if (this.canLockEntity(entity)) {
               ...
               if (d < range * range && d < dist && inLockRange(entityLocker, user.rotationYaw, user.rotationPitch, entity, angle)) {
                  ...
                  Vec3 v2 = W_WorldFunc.getWorldVec3(
                     this.worldObj, entity.posX, entity.posY + entity.height / 2.0F, entity.posZ
                  );
   ...
   public static float getEntityStealth(Entity entity) {
      if (entity instanceof MCH_EntityAircraft) {
         ...
         return entity != null && entity.ridingEntity instanceof MCH_EntityAircraft ? ((MCH_EntityAircraft)entity.ridingEntity).getStealth() : 0.0F;
      }
   }
