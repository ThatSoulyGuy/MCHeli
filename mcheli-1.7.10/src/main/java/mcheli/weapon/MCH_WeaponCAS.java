...
public class MCH_WeaponCAS extends MCH_WeaponBase {
   ...
   public boolean shot(MCH_WeaponParam prm) {
      ...
      Vec3 src = W_WorldFunc.getWorldVec3(this.worldObj, prm.entity.posX, prm.entity.posY + 2.0, prm.entity.posZ);
      Vec3 dst = W_WorldFunc.getWorldVec3(this.worldObj, prm.entity.posX + tX, prm.entity.posY + tY + 2.0, prm.entity.posZ + tZ);
