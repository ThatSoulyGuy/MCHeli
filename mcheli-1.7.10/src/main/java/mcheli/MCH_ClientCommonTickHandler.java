...
public class MCH_ClientCommonTickHandler extends W_TickHandler {
   ...
   public void onTick() {
      ...
      if (player == null || ac == null || ac.isDestroyed()) {
         lockedSoundCount = 0;
         isLocked = false;
      } else if (isLocked && lockedSoundCount == 0) {
         isLocked = false;
         lockedSoundCount = 20;
      ...
      if (!W_McClient.isGamePaused()) {
         ...
         if (player != null) {
            ...
            if (player.ridingEntity instanceof MCH_EntityHeli
               || player.ridingEntity instanceof MCP_EntityPlane
               || player.ridingEntity instanceof MCH_EntityTank) {
            ...
            if (ac != null && ac.canMouseRot()) {
               ...
               if (seat != null && seat.getParent() != null) {
                  ...
                  Vec3 v = Vec3.createVectorHelper(mouseDeltaX, mouseRollDeltaY, 0.0);
   ...
   public void onPlayerTickPre(EntityPlayer player) {
      if (player.worldObj.isRemote) {
         ...
         if (currentItemstack != null
            ...
            && player.getItemInUse() != currentItemstack) {
